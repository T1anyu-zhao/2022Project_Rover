...
int op_from_v;
float d_o_v, d_o;//d_o_v is the distance from the obstacle to the camera
float angle_o;
float del_x;
float del_y;
float safe_d = 200;
...
// Values for rerouting
int i, p=2, period;
int increment = 200; //in declearation
      ...
      while(i < p){
        ...
        if(!go_straight_1 && go_straight_4){
          ...
          if(g == 1){
            ...
            //final_destination_x = destination_x;
            //final_destination_y = destination_y;
          }
