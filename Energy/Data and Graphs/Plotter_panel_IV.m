dataplot = xlsread('Plotter.xlsx', 'Sheet3','T5:W19');
...
legend({'larger angle','smaller angle','larger best fit','smaller best fit'},'Location','Southwest');

xlabel('Voltage (V)')
ylabel('Current (A)')
title('IV Characteristics of PV panel')
grid on
